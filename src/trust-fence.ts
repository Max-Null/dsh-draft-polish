/**
 * Browser-trust fence for the draft-polish route, behaviorally identical to
 * the /api gateway's fence (Host-header loopback or a configured trusted
 * authority passes; cross-site browser markers refuse). This is a
 * DNS-rebinding / cross-site defense, not authentication.
 *
 * Copied from dsh-sidebar-qa's trust-fence (MIT) — the two plugins share
 * the same trust model and this file is small enough to keep in sync by
 * hand instead of crossing plugin boundaries.
 */
